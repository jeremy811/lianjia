...
#            print('parse_xiaoqu-url:\n', url)
#            yield Request(url=url, callback=self.parse_chengjiao, meta={'xq_name':xq_name, 'region':response.meta['region']})
            url = "https://sz.lianjia.com/api/headerSearch?channel=chengjiao&keyword=" + quote(xq_name)
            yield Request(url=url, callback=self.parse_chengjiao_xiaoqu_search, meta={'xq_name': xq_name, 'region': response.meta['region']})

    def parse_chengjiao_xiaoqu_search(self, response):
        js = json.loads(response.text)
        print('the respond is:\n', js)
...
#            print('parse_chengjiao-url_page:\n', url_page)
#            yield Request(url=url_page, callback=self.parse_content, meta={'region': response.meta['region']})
    ...
    def parse_content(self,response):
        ...
        print('there are %d chengjiao jilu: \n' %(len(cj_list)))
